##### Analysis of EQ-VAS MCID (knees) - SIMPLE MODEL 18 predictors
...
AMP_KNEES_CLEANED3.small<-AMP_KNEES_CLEANED3.small
#.........................................................................................
#.........................................................................................
...
### Outcome reference level set as YES
...
# NO outcome class imbalance --> NO upsampling during training
### Select predictors for simple model OKSVAS MCID
...
##### Welsh Test set
AMP_KNEES_CLEANED3.test<-AMP_KNEES_CLEANED3.small
### Setting the factor order for outcome variable VAS_MCID for dataset AMP_KNEES_CLEANED3.test
AMP_KNEES_CLEANED3.test[AMP_KNEES_CLEANED3.test$VAS_MCID==1,]$VAS_MCID<-"YES"
AMP_KNEES_CLEANED3.test[AMP_KNEES_CLEANED3.test$VAS_MCID==0,]$VAS_MCID<-"NO"
AMP_KNEES_CLEANED3.test$VAS_MCID <- factor(AMP_KNEES_CLEANED3.test$VAS_MCID, levels = c("YES", "NO"))
## --> predicting the probability of not achieving PostOp VAS MCID
#table(AMP_KNEES_CLEANED3.test$VAS_MCID)
#prop.table(table(AMP_KNEES_CLEANED3.test$VAS_MCID))
#.........................................................................................
#.........................................................................................

# Train XGBoost on EQ-VAS hips ----------------------------------------
attach("code/02_ML_main_EQVAS_knees.RData")
English.training.1618.VAS.simple<-English.training.1618.VAS.simple
English.test.1819<-English.test.1819
...
#### saved in 
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_XGBTREE_VAS_simple_EngTest.RData")
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_XGBTREE_VAS_simple_WelshTest.RData")
...
# Test XGBoost on EQ-VAS knees (English Test set)----------------------------------------
...
# X-squared = 1.6441, df = 8, p-value = 0.99
...
#head(pred.Mod_XGBTREE.1618.VAS.simple) 
...
write.csv(METRICS_Mod_XGBTREE.1618.VAS.simple_EngTest,
          "output/thesis_files/METRICS_Mod_XGBTREE.1618.VAS.knees.simple_EngTest.csv", row.names = FALSE)
#.........................................................................................
#.........................................................................................

# Test XGBoost on EQ-VAS knees (Welsh Test set)----------------------------------------
### Predicting probability scores on Welsh test set
probsTest.Mod_XGBTREE.1618.VAS.simple <- predict(Mod_XGBTREE.1618.VAS.simple, 
                                                 newdata = AMP_KNEES_CLEANED3.test, type = "prob")
### calibration curves (caret package)
cal.Mod_XGBTREE.1618.VAS.simple.WelshTest<-cbind(AMP_KNEES_CLEANED3.test$VAS_MCID,
...
## Hosmer-Lemeshow calibration
#head(AMP_KNEES_CLEANED3.test$VAS_MCID) ##true outcome
#head(probsTest.Mod_XGBTREE.1618.VAS.simple)[1] ## predicted score
cal.Mod_XGBTREE.1618.VAS.simple.WelshTest<-cbind(AMP_KNEES_CLEANED3.test$VAS_MCID,
                                                 probsTest.Mod_XGBTREE.1618.VAS.simple[1])
...
#Hosmer and Lemeshow goodness of fit (GOF) test
# X-squared = 2.2642, df = 8, p-value = 0.9718
...
conf.Matrix.Mod_XGBTREE.1618.VAS.simple<-confusionMatrix(
  data = pred.Mod_XGBTREE.1618.VAS.simple,
  reference = AMP_KNEES_CLEANED3.test$VAS_MCID,
  positive = "YES")
#conf.Matrix.Mod_XGBTREE.1618.VAS.simple$table
...
write.csv(METRICS_Mod_XGBTREE.1618.VAS.simple_WelshTest,
          "output/thesis_files/METRICS_Mod_XGBTREE.1618.VAS.simple_WelshTest.csv", row.names = FALSE)
#.........................................................................................
#.........................................................................................
...
#### saved in 
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_LR_VAS_simple_EngTest.RData")
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_LR_VAS_simple_WelshTest.RData")
...
best_p_threshold.Mod_LR.1618.VAS.simple<-ths.Mod_LR.1618.VAS.simple[ths.Mod_LR.1618.VAS.simple$J == 
                                                                    ...
                                                                    "prob_threshold"]
best_p_threshold.Mod_LR.1618.VAS.simple ## p = 0.4
### variable importance
...
# Test Logistic Regression on EQ-VAS knees (English Test set)----------------------------------------
### Predicting probability scores on English test set
...
write.csv(METRICS_Mod_LR.1618.VAS.simple_EngTest,
          "output/thesis_files/METRICS_Mod_LR.1618.VAS.simple_EngTest.csv", row.names = FALSE)
#.........................................................................................
#.........................................................................................

# Test Logistic Regression on EQ-VAS knees (Welsh Test set)----------------------------------------
### Predicting probability scores on Welsh test set
probsTest.Mod_LR.1618.VAS.simple <- predict(Mod_LR.1618.VAS.simple, 
                                            newdata = AMP_KNEES_CLEANED3.test, type = "prob")
### calibration curves (caret package)
cal.Mod_LR.1618.VAS.simple.WelshTest<-cbind(AMP_KNEES_CLEANED3.test$VAS_MCID,
                                            probsTest.Mod_LR.1618.VAS.simple)
...
write.csv(METRICS_Mod_LR.1618.VAS.simple_WelshTest,
          "output/thesis_files/METRICS_Mod_LR.1618.VAS.simple_WelshTest.csv", row.names = FALSE)
#.........................................................................................
#.........................................................................................

# Train Neural Net on EQ-VAS knees ----------------------------------------
attach("code/02_ML_main_EQVAS_knees.RData")
English.training.1618.VAS.simple<-English.training.1618.VAS.simple
...
#### saved in 
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_NNET_VAS_simple_EngTest.RData")
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_NNET_VAS_simple_WelshTest.RData")
...
# Test Neural Net on EQ-VAS knees (English Test set)----------------------------------------
### Predicting probability scores on English test set
...
write.csv(METRICS_Mod_NNET.1618.VAS.simple_EngTest,
          "output/thesis_files/METRICS_Mod_NNET.1618.VAS.simple_EngTest.csv", row.names = FALSE)
#.........................................................................................
#.........................................................................................

# Test Neural Net on EQ-VAS knees (Welsh Test set)----------------------------------------
### Predicting probability scores on Welsh test set
probsTest.Mod_NNET.1618.VAS.simple <- predict(Mod_NNET.1618.VAS.simple, 
                                              newdata = AMP_KNEES_CLEANED3.test, type = "prob")
### calibration curves (caret package)
cal.Mod_NNET.1618.VAS.simple.WelshTest<-cbind(AMP_KNEES_CLEANED3.test$VAS_MCID,
                                              probsTest.Mod_NNET.1618.VAS.simple)
...
write.csv(METRICS_Mod_NNET.1618.VAS.simple_WelshTest,
          "output/thesis_files/METRICS_Mod_NNET.1618.VAS.simple_WelshTest.csv", row.names = FALSE)
#.........................................................................................
#.........................................................................................
...
#### saved in 
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_RF_VAS_simple_EngTest.RData")
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_RF_VAS_simple_WelshTest.RData")
...
write.csv(METRICS_Mod_RF.1618.VAS.simple_EngTest,
          "output/thesis_files/METRICS_Mod_RF.1618.VAS.simple_EngTest.csv", row.names = FALSE)
#.........................................................................................
#.........................................................................................
...
probsTest.Mod_RF.1618.VAS.simple <- predict(Mod_RF.1618.VAS.simple, 
                                            newdata = AMP_KNEES_CLEANED3.test, type = "prob")
### calibration curves (caret package)
cal.Mod_RF.1618.VAS.simple.WelshTest<-cbind(AMP_KNEES_CLEANED3.test$VAS_MCID,
                                            probsTest.Mod_RF.1618.VAS.simple)
...
write.csv(METRICS_Mod_RF.1618.VAS.simple_WelshTest,
          "output/thesis_files/METRICS_Mod_RF.1618.VAS.simple_WelshTest.csv", row.names = FALSE)
#.........................................................................................
#.........................................................................................

# Train Elastic Net on EQ-VAS knees ---------------------------------------
attach("code/02_ML_main_EQVAS_knees.RData")
...
#### saved in 
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_GLMNET_VAS_simple_EngTest.RData")
#load("code/models/EQVAS_knees_simple/KNEES_ML_training_1618_GLMNET_VAS_simple_WelshTest.RData")
...
write.csv(METRICS_Mod_GLMNET.1618.VAS.simple_EngTest,
          "output/thesis_files/METRICS_Mod_GLMNET.1618.VAS.simple_EngTest.csv", row.names = FALSE) 
#.........................................................................................
#.........................................................................................
...
probsTest.Mod_GLMNET.1618.VAS.simple <- predict(Mod_GLMNET.1618.VAS.simple, 
                                                newdata = AMP_KNEES_CLEANED3.test, type = "prob")
### calibration curves (caret package)
cal.Mod_GLMNET.1618.VAS.simple.WelshTest<-cbind(AMP_KNEES_CLEANED3.test$VAS_MCID,
                                                probsTest.Mod_GLMNET.1618.VAS.simple)
...
write.csv(METRICS_Mod_GLMNET.1618.VAS.simple_WelshTest,
          "output/thesis_files/METRICS_Mod_GLMNET.1618.VAS.simple_WelshTest.csv", row.names = FALSE)
